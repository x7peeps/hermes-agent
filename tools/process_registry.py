...
class ProcessRegistry:
    ...
    def drain_notifications(
        ...
        into the wrong session is a cross-chat leak (#58684, #55578, #64484).
        Two filter modes, strongest wins:
        ...
        while not self.completion_queue.empty():
            ...
            # wrong session/thread (#58684, #55578, #64484). Positive-proof
            # callback beats bare key equality when the caller can provide one.

...
class TestCliRefreshIntervalConfig:
    """Test the CLI refresh_interval config default (#45592 / #48309 / #63895)."""

    def test_default_config_disables_cli_refresh_interval(self):
        """cli_refresh_interval defaults to 0 to prevent periodic redraws
        from fighting terminal auto-scroll in non-fullscreen mode (#48309,
        #63895). Users who need the wall-clock status-bar clock to tick can
        set it to 1.0 on emulators that handle it correctly."""
